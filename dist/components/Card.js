  ...
  function Card() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Card.__proto__ || (0, _getPrototypeOf2.default)(Card)).call.apply(_ref, [this].concat(args))), _this), _this.removeCard = function (e) {
      ...
      if (_this.props.customCardLayout) {
        ...
        var customCardWithProps = _react2.default.cloneElement(customCard, (0, _extends3.default)({}, otherProps));
  ...
  (0, _createClass3.default)(Card, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          otherProps = (0, _objectWithoutProperties3.default)(_props, ['id', 'connectDragSource', 'connectDropTarget', 'isDragging', 'cardStyle', 'editable', 'customCardLayout']);
      ...
      return connectDragSource(connectDropTarget(_react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          (0, _extends3.default)({ key: id, 'data-id': id }, otherProps, { style: (0, _extends3.default)({}, style, { opacity: opacity }) }),
          this.renderBody(),
          editable && _react2.default.createElement(_DeleteButton2.default, { onClick: this.removeCard })
        )
      )));
    }
  }]);
